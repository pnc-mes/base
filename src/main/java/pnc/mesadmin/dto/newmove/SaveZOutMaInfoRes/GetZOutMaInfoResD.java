...
import pnc.mesadmin.dto.GetOutMaInfo.GetOutMaInfoResDPicker;
 ...
 * @Description:
 */
public class GetZOutMaInfoResD {
    ...
    private List<GetZOutMaInfoResDOutDlInfo> OutDlInfo;
    ...
    @JsonIgnore
    public List<GetZOutMaInfoResDOutDlInfo> getOutDlInfo() {
        return OutDlInfo;
    }
    @JsonIgnore
    public void setOutDlInfo(List<GetZOutMaInfoResDOutDlInfo> outDlInfo) {
        OutDlInfo = outDlInfo;
    }
    @JsonIgnore
