 ...
 */
public class GetBOMInfoResDBMInfo  implements Serializable{
    ...
    private List<GetBOMInfoResDBReMaInfo> ReMaInfo;
    ...
    @JsonIgnore
    public List<GetBOMInfoResDBReMaInfo> getReMaInfo() {
        return ReMaInfo;
    }

    @JsonIgnore
    public void setReMaInfo(List<GetBOMInfoResDBReMaInfo> reMaInfo) {
        ReMaInfo = reMaInfo;
    }
}
