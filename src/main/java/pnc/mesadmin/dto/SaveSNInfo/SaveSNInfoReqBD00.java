 ...
 * 公司名称：驭航信息技术(上海)有限公司
 * 系统名称：PNC-MES管理系统
 * 子系统名称：新增工序管理DTO返回业务数据实体类Res
 * 创建人：张亮亮
 * 创建时间：2017-06-07
 * 修改人：
 * 修改时间：
 */
public class SaveSNInfoReqBD00 implements Serializable{
    ...
    @JsonIgnore
    public List<SaveSNInfoReqBD00.BFInfo> getBFInfo() {
        return BFInfo;
    }

    @JsonIgnore
    public void setBFInfo(List<SaveSNInfoReqBD00.BFInfo> BFInfo) {
        this.BFInfo = BFInfo;
    }
