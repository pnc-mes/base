 ...
 * 修改时间：
 */
public class SaveToolFamilyInfoReqBD02 implements Serializable{
    ...
    @JsonProperty("PMInfo")
    private List<SaveToolFamilyInfoReqBD02PM> PMInfo;
    @JsonIgnore
    public List<SaveToolFamilyInfoReqBD02PM> getPMInfo() {
        return PMInfo;
    }
    @JsonIgnore
    public void setPMInfo(List<SaveToolFamilyInfoReqBD02PM> PMInfo) {
        this.PMInfo = PMInfo;
    }
