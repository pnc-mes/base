 ...
 */
public class SaveWfInfoReqBD02 implements Serializable{
    ...
    @JsonProperty("WfInfo")
    private List<SaveWfInfoReqBD02WfInfo> WfInfo;
    ...
    @JsonIgnore
    public List<SaveWfInfoReqBD02WfInfo> getWfInfo() {
        return WfInfo;
    }

    @JsonIgnore
    public void setWfInfo(List<SaveWfInfoReqBD02WfInfo> wfInfo) {
        WfInfo = wfInfo;
    }
