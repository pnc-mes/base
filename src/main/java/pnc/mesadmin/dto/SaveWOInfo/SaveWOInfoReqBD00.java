 ...
 * 修改时间：
 */
public class SaveWOInfoReqBD00 implements Serializable{
  ...
  @JsonProperty("LineInfo")
    private List<SaveOrderLineInfoReq00OrderList> LineInfo;
  /*@JsonProperty("LineRd")
  private int  LineRd;*/
    @JsonProperty("Remark")
    private String  Remark;
    @JsonIgnore
    public List<SaveOrderLineInfoReq00OrderList> getLineInfo() {
        return LineInfo;
    }
    @JsonIgnore
    public void setLineInfo(List<SaveOrderLineInfoReq00OrderList> lineInfo) {
        LineInfo = lineInfo;
    }
