 ...
 * 修改时间：
 */
public class SaveToolInfoReqBD00 implements Serializable{
    ...
    @JsonIgnore
    public List<SaveToolInfoReqBD00PM> getPMInfo() {
        return PMInfo;
    }
    @JsonIgnore
    public void setPMInfo(List<SaveToolInfoReqBD00PM> PMInfo) {
        this.PMInfo = PMInfo;
    }
    @JsonIgnore
    public SaveToolInfoReqToolBZInfo getToolBZInfo() {
        return ToolBZInfo;
    }
    @JsonIgnore
    public void setToolBZInfo(SaveToolInfoReqToolBZInfo toolBZInfo) {
