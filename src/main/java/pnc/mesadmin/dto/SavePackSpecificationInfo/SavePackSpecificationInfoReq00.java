 ...
 */
public class SavePackSpecificationInfoReq00 implements Serializable{
    ...
    @JsonIgnore
    public List<SavePackSpecificationInfoReq00.Property> getProperty() {
        return Property;
    }
    @JsonIgnore
    public void setProperty(List<SavePackSpecificationInfoReq00.Property> property) {
        Property = property;
    }
    @JsonIgnore
