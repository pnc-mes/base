...
public class SaveRePrInfoReqBD01 {

    @JsonProperty("RePrInfo")
    private List<SaveRePrInfoReqBD01RePrInfo> RePrInfo;
    ...
    @JsonIgnore
    public List<SaveRePrInfoReqBD01RePrInfo> getRePrInfo() {
        return RePrInfo;
    }

    @JsonIgnore
    public void setRePrInfo(List<SaveRePrInfoReqBD01RePrInfo> rePrInfo) {
        RePrInfo = rePrInfo;
    }
