...
public class CSConfigController {
    ...
    @Resource
    CSConfigService csConfigService;
    ...
    public BaseRes SaveCSInfo(SaveReq saveReq) throws SystemException {
        ...
        try {
            if ("00".equals(saveReq.getExecType())) {
                GetCsConfigV2Res getAllAppSetReq = CommonUtils.switchClass(GetCsConfigV2Res.class, saveReq.getBusData());
                //新增
