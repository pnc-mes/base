...
public class PickBatchInfo {
    ...
    private String pickor;
    private Date pickorTime;
    ...
    public String getPickor() {
        return pickor;
    }

    public void setPickor(String pickor) {
        this.pickor = pickor;
    }

    public Date getPickorTime() {
        return pickorTime;
    }

    public void setPickorTime(Date pickorTime) {
        this.pickorTime = pickorTime;
    }
