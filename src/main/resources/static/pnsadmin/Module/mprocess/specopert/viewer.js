...
if (typeof window !== 'undefined' && window['pdfjs-dist/build/pdf']) {
  ...
  pdfjsLib = require(getBasePath()+'/pdf.js');
}
...
function configure(PDFJS) {
  PDFJS.imageResourcesPath = getBasePath()+'/static/plugins/pdf/images/';
  PDFJS.workerSrc = getBasePath()+'/static/plugins/pdf/pdf.worker.js';
