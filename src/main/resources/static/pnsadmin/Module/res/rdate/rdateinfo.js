$(function(){
    ...
    var tableflag=false;
    var treeID=null;
    var PresetEmailDistributionRd=null;
    var PresetEmailMessageRd=null;

    var StartEmailDistributionRd=null;
    var StartEmailMessageRd=null;

    var OverEmailDistributionRd=null;
    var OverEmailMessageRd=null;
    var colNamesArr = [
        {"Caption": "CyclePlanDtlRd", "Name": "CyclePlanDtlRd", "Hidden": true},
        {"Caption": "TaskRd", "Name": "TaskRd", "Hidden": true},
        {"Caption": "任务名称", "Name": "TaskName","Hidden": true},
        {"Caption": "任务描述", "Name": "TaskItemName", "CType": "text"},
    ...
    var onClicks = function (nodeinfo, handle) {
        ...
        var objBusData = JSON.stringify({"CyclePlanRd": treeID});
        var objData = {
            "ExecType": "00",
            "BusData": objBusData,
        };
        request({url:"/CyclePlan/GetCyclePlanInfo", data: objData},function(Body){

                $("#CyclePlanName").val(Body.Data.CyclePlanName);
        ...
        //$("#gqcqxd").val(Body.Data.OverTimeAction);
            var sourcedata=Body.Data.CyclePlanDtlInfo;
            tableflag=true;
            var dataS=[];
            for(var i in sourcedata){
                data={
                    "CyclePlanDtlRd":sourcedata[i].CyclePlanDtlRd,
    ...
    $(".searchTree").click(function () {
        ...
        currentPage = 0;
        currentPage = treeSearchs("/CyclePlan/GetAllCyclePlanInfo","CyclePlanRd","CyclePlanName","CyclePlanName",condition,currentPage,config);
        if(currentPage < 0){
            condition = "";
            currentPage = temp;
        }
    ...
    var loaddata = function () {
        ...
        request({
            url:'/CyclePlan/GetAllCyclePlanInfo',
            data: {
                "ExecType": "00",
            ...
            if(treeData.length>0){
                ...
                for (var i = 0; i < len; i++) {
                    var tree = {
                        id: treeData[i].CyclePlanRd == undefined ? "" : treeData[i].CyclePlanRd,
                        name: treeData[i].CyclePlanName == undefined ? "" : treeData[i].CyclePlanName
                    };
    ...
    $(".cAdd").click(function () {
      ...
      /*  $("#rxxxgc").val("0");*/
        ...
        e1=null;
        f1=null;
        PresetEmailDistributionRd=null;
        PresetEmailMessageRd=null;

        StartEmailDistributionRd=null;
        StartEmailMessageRd=null;

        OverEmailDistributionRd=null;
        OverEmailMessageRd=null;
    ...
    $(".cSave").click(function () {
        ...
        var data = getTableData("list4");  //getRowData和getTableData区别是什么？？？
        ...
        var DownTime="0";/*$("#rxxxgc").val().trim();*/
        var UpTime=$("#rxsxgc").val().trim();
        var PresetTime=$("#xtsj").val().trim();
      //  var PresetEmailDistributionRd=$("#goaheademail").getseldata().EmailDisRd;
        //var PresetEmailMessageRd=$("#goaheademailcontent").getseldata().EmailRd;

        //var StartEmailDistributionRd=$("#daoqiGroup").getseldata().EmailDisRd;
        //var StartEmailMessageRd=$("#daoqiContent").getseldata().EmailRd;

       // var OverEmailDistributionRd=$("#expiremailgroup").getseldata().EmailDisRd;
       // var OverEmailMessageRd=$("#expiremailcontent").getseldata().EmailRd;
        ...
        if(treeID==null){
            ...
            var data={
                ...
                "CyclePlanDtlInfo":CyclePlanDtlInfos,
                "Remark":Remark,
            }

            request({url:"/CyclePlan/SaveCyclePlanInfo", data: {"ExecType": "00", "busData": JSON.stringify(data)}},function(Body){
            ...
            for(var i in data){
                var CyclePlanDtlInfo={
                    "CyclePlanDtlRd":data[i].CyclePlanDtlRd,
                    "TaskRd":data[i].TaskRd,
                    "TaskName":data[i].TaskName,
                    "TaskItemName":data[i].TaskItemName,
                    "SureType":data[i].SureType,
            ...
            request({url:"/CyclePlan/SaveCyclePlanInfo", data: {"ExecType": "02", "busData": JSON.stringify(data)}},function(Body){
                toastr.success(Body.MsgDes);
                $("#bynrqd").selectpicker('val',"");
                currentPage=0;
                condition = '';
    ...
    $(".cDel").click(function () {
        if (treeID != undefined && treeID != null && treeID.trim() != ""){
            layer.confirm('确认要删除吗？', {
                    ...
                    request({url:"/CyclePlan/SaveCyclePlanInfo", data: {"ExecType": "01", "busData": "{\"CyclePlanRd\":" + treeID + "}"}},function(Body){
