...
$(function () {
    ...
    var changeBeforeWidth = '100%';//定义变量，接收放大前的宽度
    /*var _data = [];
    ...
    $.fn.zc_select = function (entryParam) {
        ...
        $("body").after(
            ...
            '<p><span class="selectSpan" style="color:#fff;margin-right: 10px;padding-left: 25px;">选择</span><span class="selectTitle" style="color:#fff;">选择信息</span></p>' +
        ...
        $layerContent.css({'border-radius':'8px','border':"3px solid #cccccc","padding":"10px","width":"1300px","height":"800px","background":"#fff","z-index":"100000"});
        /*样式*/
        ...
        $topTitle.find('p:nth-child(1)').css({'float':"left","margin":'-15px'});
        $topTitle.find('p:nth-child(2)').css({"float":"right","margin":"-10px"});
        ...
        $ulList.css({"border":"1px solid #ccc","background-color":"#fff","margin":"0","padding-left":"0","height":"610px","width":"100%","overflow-y":"auto","overflow-x":"hidden", "clear":" both","display":"none"});
        ...
        $('.topInformation').css({'border-radius':'4px','-webkit-box-shadow':"rgb(136, 136, 136) 3px 5px 4px",'-moz-box-shadow':"rgb(136, 136, 136) 3px 5px 4px",'box-shadow':"rgb(136, 136, 136) 3px 5px 4px","padding-top":"20px",'background':'rgb(60, 141, 188)',"margin-bottom":"7px"});
        $('#f2').css('float','left');
...
//双击处理li数据回显到文本框中？
        ...
        function dealOpenHasTitle(){
            ...
            $defaultImg.on('click', function () {
                ...
                //弹窗定位
                $layerContent.css({'position': 'absolute', 'top': '10%', 'left': '15%'});
                //可以自由拖拽
                $layerContent.draggable({containment: "body", scroll: false, cursor: "move"});
                //可以自由拉伸弹窗
        ...
        function dealOpenNotTitle(){
            ...
            $defaultImg.on('click', function () {
                ...
                $layerContent.css('display', 'block');
                //弹窗定位
                $layerContent.css({'position': 'absolute', 'top': '10%', 'left': '15%','width':'70%','height':'70%'});
                //可以自由拖拽
                $layerContent.draggable({containment: "body", scroll: false, cursor: "move"});
                //可以自由拉伸弹窗
                //$layerContent.resizable();
        ...
        function getwihei() {
            ...
            $layerContent.css({"width": changeBeforeWidth, "height": changeBeforeHeight, "top": "10%", "left": "15%"});
