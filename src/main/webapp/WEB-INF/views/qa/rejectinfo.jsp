...
<div class="btn-group table tabTop fix td1">
    ...
    <button type="button" class="btn btn-primary" id="save">标记不良</button>
                                ...
                                <div class="tab-pane active clearfix" id="tab_1">
                                    <div class="box-body  form-inline">
                                        <div class='f1'>
                                            ...
                                            <div class="form-group formgroup">
                                                <label>不良数量</label>
                                                <input type="Number" class="form-control check" id="Num" name="Num"
                                                       placeholder="">
                                            </div>
                                        </div>
                                    </div>
...
<script src="${pageContext.request.contextPath}/static/pnsadmin/Module/qa/rejectinfo.js?v=1"></script>
