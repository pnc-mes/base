...
<div class="f2 clearfix">
    <div class="zsyLeft">
        <div class="left zsyZi" id="left2">
            <input class="input1 form-control" type="search" name="" value="" placeholder="搜索检验水平">
                ...
                <div class="col-md-12">
                    <div class="nav-tabs-custom">
                        <ul class="nav nav-tabs">
                            <li class="active"><a href="#tab_1" data-toggle="tab" class="dymb">检验水平信息</a></li>
                                ...
                                <div class="box-body formBottom">
                                    <div class="printTInfo">
                                        <div class="form-group formgroup biaodan1 hangji">
                                            <label for="CheckLevelCode">检验水平代码</label>
                                            <input type="text" class="form-control check" id="CheckLevelCode"
                                                   name="CheckLevelCode" placeholder="" maxlength="40">
                                            <label for="CheckLevelName">检验水平名称</label>
                                            <input type="text" class="form-control check" id="CheckLevelName"
                                                   name="CheckLevelName" placeholder="" maxlength="50">
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<script src="${pageContext.request.contextPath}/static/pnsadmin/Module/qa/jyx/jyspinfo.js?v=1"></script>
</body>
</html>
