...
<div class="f2 clearfix">
    <div class="zsyLeft" >
        <div class="left left1 zsyZi" id="left2" >
            <input class="input1 form-control" type="search" name="" value="" placeholder="搜索检验类型">
                ...
                <div class="col-md-12">
                    <div class="nav-tabs-custom">
                        <ul class="nav nav-tabs">
                            <li class="active"><a href="#tab_1" data-toggle="tab" class="dymb">检验类型清单</a></li>
                        ...
                        <div class="box-body form-inline" style="margin-bottom: 10px;padding-right: 50px">
                            <div class="printTInfo disblock">
                                <div class="form-group formgroup">
                                    <label for="CheckTypeCode">检验类型代码</label>
                                    <input type="text" class="form-control read check" id="CheckTypeCode"
                                           name="CheckTypeCode" placeholder="" maxlength="50">
                                </div>
                                ...
                                <div class="form-group formgroup">
                                    <label for="CheckTypeName">检验类型名称</label>
                                    <input type="text" class="form-control read check" id="CheckTypeName"
                                           name="CheckTypeName" placeholder="" maxlength="50">
                                </div>
                            </div>
...
<script src='${pageContext.request.contextPath}/static/pnsadmin/Module/qa/jyx/jylx.js?v=2'></script>
