                ...
                <div class="col-md-12">
                    <div class="nav-tabs-custom">
                        <ul class="nav nav-tabs">
                            <li class="active"><a href="#tab_1" data-toggle="tab" class="dymb">冻结批次原因信息</a></li>
...
<script src="${pageContext.request.contextPath}/static/pnsadmin/Module/qa/freezers/freezerinfo.js?v=1"></script>
</body>
</html>
