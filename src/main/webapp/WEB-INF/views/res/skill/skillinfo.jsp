...
<div class="f2 clearfix">
    <div class='zsyLeft'>
        <div class="left left1 zsyZi" id="left2">
            <input class="input1 form-control" type="search" name="" value="" placeholder="搜索技能名称">
                                ...
                                <div class="box-body form-inline">
                                    <div class="printTInfo">
                                        <div class=" formgroup disblock">
                                            ...
                                            <input type="text" class="form-control check" id="skillName"
                                                   name="skillName" placeholder="" maxlength="100">

                                            <label >有效期
                                            <input type="number" class="form-control check" id="VPDate"
                                                   name="VPDate" placeholder="">
                                                月
                                            </label>
                                        </div>
                                        <div>
                                            <label class="labell">状&emsp;&emsp;态
                                                <select id="Status" name="Statuss" class="form-control" style="padding: 1px 6px;">
...
<script src='${pageContext.request.contextPath}/static/pnsadmin/Module/res/skill/skillinfo.js?v=1'></script>
</body>
