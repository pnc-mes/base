...
<div class="f2 clearfix">
    <div class="zsyLeft">
        <div class="left zsyZi" id="left2">
            <input class="input1 form-control" type="search" name="" value="" placeholder="搜索设备状态变更原因">
    ...
    <form class="form-inline" id="reasonForm">
        <div class="right" id="_right" style="display: none;">
            <div class="row rightTop">
                <div class="col-md-12">
                    <div class="nav-tabs-custom">
                        <ul class="nav nav-tabs">
                            <li class="active"><a href="#tab_1" data-toggle="tab" class="dymb">设备状态变更原因信息</a></li>
                                ...
                                <div class="box-body formBottom">
                                    <div class="printTInfo">
                                        <div class="form-group formgroup biaodan1 hangji">
                                            <label for="reaCode">原因代码</label>
                                            <input type="text" class="form-control check" id="reaCode"
                                                   name="reaCode" placeholder="" maxlength="40">
                                            <label for="reaDes">原因描述</label>
                                            <input type="text" class="form-control check" id="reaDes"
                                                   name="reaDes" placeholder="" maxlength="50">
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<script src="${pageContext.request.contextPath}/static/pnsadmin/Module/res/destatecrs/destatecrsinfo.js?v=1"></script>
</body>
</html>
