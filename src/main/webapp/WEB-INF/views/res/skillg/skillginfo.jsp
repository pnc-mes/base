...
<div class="btn-group td1  table common">
    ...
    <div class="btn btn-primary cAdd" id="cAdd">新增</div>
    ...
    <div class="btn-group">
        ...
        <ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu1">
            <%--<li role="presentation" id="copySkillGd"><a name="copy" class="text-center" role="menuitem" tabindex="-1">复制</a></li>--%>
            <li role="presentation" id="delSkillGd"><a  class="text-center cDel" role="menuitem" tabindex="-1">删除</a>
            </li>
        </ul>
    </div>
    <%--<div class="btn-group">
...
<div class="f2  clearfix zsyLeft1  clearfix">
    <div class="left zsyZi1 " id="left2">
        <input class="input1 form-control" type="search" name="" value="" placeholder="搜索技能组">
                ...
                <div class="col-md-12">
                    <div class="nav-tabs-custom">
                        <ul class="nav nav-tabs">
                            <li class="active"><a href="#tab_1" data-toggle="tab" class="dymb">技能组信息</a></li>
                            ...
                            <div class="tab-pane active" id="tab_1">
                                <div class="box-body form-inline">
                                    <div class="devGpName">
                                        <div class="form-group formgroup">
                                            <label for="devGpName">技能组名称</label>
                                            <input type="text" class="form-control check" id="devGpName"
                                                   name="devGpName" placeholder="" maxlength="40">
                                        </div>
                                    </div>
                                </div>
                                <div class="content clearfix">
                                    ...
                                    <div class="f2_4 btn-group">
                                        <div class="btn btn-primary add1" id="add1">新增</div>
                                        <div class="btn btn-primary del1" id="del1">删除</div>
                                    </div>
                                    <section >
                                        <div class="row">
                                            <div class="col-md-12">
...
<script src='${pageContext.request.contextPath}/static/pnsadmin/Module/res/skillg/skillginfo.js?v=2'></script>
</body>
</html>
