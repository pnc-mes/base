...
<div class="f2 clearfix">
    <div class="zsyLeft">
        <div class="left zsyZi" id="left2">
            <input class="input1 form-control" type="search" name="" value="" placeholder="搜索原因代码">
                ...
                <div class="col-md-12">
                    <div class="nav-tabs-custom">
                        <ul class="nav nav-tabs">
                            <li class="active"><a href="#tab_1" data-toggle="tab" class="dymb">保养原因信息</a></li>
...
<script src="${pageContext.request.contextPath}/static/pnsadmin/Module/res/devmatcrs/devmatcrsinfo.js?v=1"></script>
</body>
</html>
