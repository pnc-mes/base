...
<div class="f2 clearfix">
    <div class='zsyLeft'>
        <div class="left left1 zsyZi" id="left2">
            <input class="input1 form-control" type="search" name="" value="" placeholder="搜索工具家族">
                                ...
                                <div class="box-body form-inline">
                                    <div class="printTInfo">
                                        <div class=" formgroup disblock">
                                            <label for="ToolFamilyName">家族名称</label>
                                            <input type="text" class="form-control check" id="ToolFamilyName"
                                                   name="ToolFamilyName" placeholder="" maxlength="80">
                                            <label for="Description" >家族描述</label>
                                            <input type="text" style="width: 194px;" id="Description"
                                                   name="Description" placeholder=""  maxlength="255">
                                        </div>

                                        <div class=" formgroup disblock">
                                            <label class="">工&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;厂</label>
                                            <div id="defaultSelect2" data-id=""></div>
                                            <label class="" style="margin-left: 105px;">状态模型</label>
...
<script src='${pageContext.request.contextPath}/static/pnsadmin/Module/res/toolFamily/toolFamilyinfo.js?v=1'></script>
