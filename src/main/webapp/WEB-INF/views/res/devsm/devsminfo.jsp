...
<div class="f2  clearfix zsyLeft1  clearfix">
    <div class="left zsyZi1 " id="left2">
        <input class="input1 form-control" type="search" name="" value="" placeholder="设备状态模型名称">
                ...
                <div class="col-md-12">
                    <div class="nav-tabs-custom">
                        <ul class="nav nav-tabs">
                            <li class="active"><a href="#tab_1" data-toggle="tab" class="dymb">设备状态模型信息</a></li>
                                ...
                                <div class="box-body form-inline">
                                    <div class="devGpName">
                                        <div class="form-group formgroup">
                                            <label for="modelName">状态模型名称</label>
                                            <input type="text" class="form-control check" id="modelName"
                                                   name="modelName" placeholder="" maxlength="50">
...
<script src='${pageContext.request.contextPath}/static/pnsadmin/Module/res/devsm/devsminfo.js?v=1'></script>
