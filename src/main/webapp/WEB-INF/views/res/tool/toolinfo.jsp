...
<div class="f2 clearfix">
    <div class='zsyLeft'>
        <div class="left left1 zsyZi" id="left2">
            <input class="input1 form-control" type="search" name="" value="" placeholder="搜索工具">
                ...
                <div class="col-md-12">
                    <div class="nav-tabs-custom">
                        <ul class="nav nav-tabs">
                            ...
                            <li id="sbtxx"><a href="#tab_4" data-toggle="tab">工具标准值</a></li>
                                ...
                                <div class="box-body form-inline">
                                    <div class="printTInfo">
                                        <div class=" formgroup disblock">
                                            ...
                                            <input type="text" class="form-control check" id="ToolName"
                                                   name="ToolName" placeholder="" maxlength="40">
                                       ...
                                       <div class=" formgroup disblock">
                                           ...
                                           <label class="" style="margin-left: 103px;">状态模型</label>
                                           <div id="defaultSelect3" data-id="" style="margin-right: 100px"></div>

                                        </div>
                                        <div class=" formgroup disblock">
                                            <label class="">供&ensp;应&ensp;商</label>
                                            <div id="defaultSelect" data-id="" style="margin-right: 100px"></div>
                                            <label for="VenderSN">序&ensp;列&ensp;号</label>
                                            <input type="text"  id="VenderSN"
                                                   name="VenderSN" maxlength="100">
                                            <%--<label for="VenderType">设备型号</label>
                                            <input type="text" id="VenderType"
                                                   name="VenderType" maxlength="100">--%>
                                        </div>
                                        <div class=" formgroup disblock">
...
<script src='${pageContext.request.contextPath}/static/pnsadmin/Module/res/tool/toolinfo.js?v=1'></script>
