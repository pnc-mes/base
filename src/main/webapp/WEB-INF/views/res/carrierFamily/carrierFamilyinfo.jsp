...
<div class="f2 clearfix">
    <div class='zsyLeft'>
        <div class="left left1 zsyZi" id="left2">
            <input class="input1 form-control" type="search" name="" value="" placeholder="搜索载具家族">
                                ...
                                <div class="box-body form-inline">
                                    <div class="printTInfo">
                                        <div class=" formgroup disblock">
                                            <label for="CarrierFamilyName">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;名称&nbsp;&nbsp;</label>
                                            <input type="text" class="form-control check" id="CarrierFamilyName"
                                                   name="CarrierFamilyName" placeholder="" maxlength="80">
                                            <label>描述&nbsp;&nbsp;</label>
                                        ...
                                        <div class=" formgroup disblock">
                                            ...
                                            <label class=""  style="margin-left: 75px;">状态模型&nbsp;&nbsp;</label>
...
<script src='${pageContext.request.contextPath}/static/pnsadmin/Module/res/carrierFamily/carrierFamilyinfo.js?v=1'></script>
