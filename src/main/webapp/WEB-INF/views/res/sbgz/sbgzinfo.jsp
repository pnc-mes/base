...
<div class="f2 clearfix">
    <div class="zsyLeft">
        <div class="left zsyZi" id="left2">
            <input class="input1 form-control" type="search" name="" value="" placeholder="搜索设备故障类型名称">
                ...
                <div class="col-md-12">
                    <div class="nav-tabs-custom">
                        <ul class="nav nav-tabs">
                            <li class="active"><a href="#tab_1" data-toggle="tab" class="dymb">设备故障类型</a></li>
                                ...
                                <div class="box-body formBottom">
                                    <div class="printTInfo">
                                        <div class="form-group formgroup biaodan1 hangji">
                                            <label for="sbgzdm">设备故障类型代码&nbsp;&nbsp;</label>
                                            <input type="text" class="form-control check" id="sbgzdm"
                                                   name="devFName" placeholder="" maxlength="80">

                                            <label for="sbgzmc">设备故障类型名称&nbsp;&nbsp;</label>
                                            <input type="text" class="form-control check" id="sbgzmc"
                                                   name="devFName" placeholder="" maxlength="80">
                                        </div>
...
<script src="${pageContext.request.contextPath}/static/pnsadmin/Module/res/sbgz/sbgzinfo.js?v=1"></script>
</body>
</html>