...
<div class="f2 clearfix" style="margin-top:30px;margin-left: 10px;">
    <form class="form-inline">
        <div class="form-group formgroup">
            <div class="form-group" style="display: block; margin-bottom: 20px;margin-top:10px;">
                <input id="hidden" type="hidden" value="${PDRd}"/>
                <label for="pand">盘点单号</label>
                <input type="text" class="form-control" id="pand" name="PDCode" placeholder=" " disabled>
            </div>
            ...
            <div class="form-group beizhu">
                ...
                <textarea id="beizhu"  name="remark" style="left:60px" maxlength="255" onchange="this.value=this.value.substring(0, 255)" onkeydown="this.value=this.value.substring(0, 255)" onkeyup="this.value=this.value.substring(0, 255)"></textarea>
            </div>
        </div>
    </form>
</div>
...
<script src="${pageContext.request.contextPath}/static/pnsadmin/Module/warehouse/instock/inventory/inventoryedit.js?v=1"></script>
