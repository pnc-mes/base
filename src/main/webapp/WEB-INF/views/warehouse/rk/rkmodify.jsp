...
<div class="f2 ">
    <div class="packcontent">
        <input type="hidden" id="hidden" value="${RkRd}"/>
        <form id="printForm">
                    ...
                    <div class="nav-tabs-custom">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active clearfix" id="tab_1">
                                <input type="hidden" value="" id="asSource"/>
...
<script src='${pageContext.request.contextPath}/static/pnsadmin/Module/warehouse/rk/rkmodify.js?v=1'></script>
</body>
</html>
