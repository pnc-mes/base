...
<div class="btn-group td1 table tabTop common">
    <input type="hidden" id="hidden2" value="" q=""/>
    <input type="hidden" id="hidden3" value="" q=""/>
    ...
    <div class="btn-group">
        ...
        <ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu1">
            <li role="presentation"><a  class="text-center cDel" role="menuitem" tabindex="-1" e="">删除</a></li>
        </ul>
    </div>
    <%--<div class="btn-group">
        <div class="btn btn-primary dropdown-toggle" data-toggle="dropdown"
...
<div class="f2 clearfix zsyLeft1">
    <div class="left left1 clearfix zsyZi1" id="left2">
        <input class="input1 form-control" type="search" name="" value="" placeholder="搜索物料">
    ...
    <div class="right" style="display: none;">
        <form id="specfileForm">
            <div class="row rightTop">
                <div class="col-md-12">
                    <div class="nav-tabs-custom">
                        <ul class="nav nav-tabs">
                            <li class="active"><a href="#tab_1" data-toggle="tab" class="dymb">物料信息</a></li>
                                    ...
                                    <div class="printTInfo">
                                        <div class="width100">
                                            <div class="form-group width30">
                                                ...
                                                <input type="text" class="form-control check mright0" id="MaCode"
                                                       name="MaCode" placeholder="" readonly>
                                            </div>
                                            <div class="form-group width30">
                                                <label for="MaName">物料名称</label>
                                                <input type="text" class="form-control check mright0" id="MaName"
                                                       name="MaName" placeholder="" readonly>
                                            </div>
                                            <div class="form-group width30">
                                                <label for="MaDes">物料描述</label>
                                                <input type="text" class="form-control check mright0" id="MaDes"
                                                       name="MaDes" placeholder="" readonly>
                                            </div>
                                        </div>
                                        <div class="width100" style="margin-top: 20px;">
                                            <div class="form-group width30">
                                                <label>工艺流程</label>
                                                <div id="wofrod" data-id=""></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>

                                <div class="nav-tabs-custom mbottom0">
                                    <ul class="nav nav-tabs">
                                        <li class="active"><a href="#tab_3" data-toggle="tab" class="dymb">生产工艺控制</a>
                                        </li>
                                        <li><a href="#tab_2" data-toggle="tab">其他</a></li>
                                    </ul>
                                    <div class="tab-content">
...
<script src='${pageContext.request.contextPath}/static/pnsadmin/Module/process/specfile/specfileinfo.js?v=1'></script>
