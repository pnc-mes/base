...
<div class="f2 clearfix">
    <div class="zsyLeft">
        <div class="left zsyZi" id="left2">
            <input class="input1 form-control" type="search" name="" value="" placeholder="搜索点检计划">
                                ...
                                <div class="form-inline">
                                    <div class="printTInfo">
                                        <div class="manWidth f1"  style="margin-top:10px;">
                                            <div class="form-group width30" style="width: 400px;">
                                                <label>&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;名称&nbsp;&nbsp;</label>
                                                <input type="text" class="form-control" id="CyclePlanName" style="width: 152px"
                                                       name="CyclePlanName" >
                                            </div>
                                            <div class="form-group width30" style="margin-left: -35px;">
                                                <label>状态&nbsp;&nbsp;</label>
                                            ...
                                            <div class="form-group width30" style="margin-left: -35px;">
                                                <label>点检类型&nbsp;&nbsp;</label>
                                                <select id="CheckPlanType" class="form-control check" style="width: 150px;padding: 1px 6px;">
                                                    <option  value="00">工艺</option>
                                                    <option  value="01">生产</option>
                                                    <option  value="02">设备</option>
                                                    <option  value="03">质量</option>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="manWidth f1"  style="margin-top:10px;">
                                            ...
                                            <div class="form-group width20" style=" ">
                                                <label >保养标准作业书&nbsp;&nbsp;</label>
                                        ...
                                        <div class="manWidth f1"  style="margin-top:10px;">
                                            <div class="form-group width30">
                                                <label>&ensp;&ensp;&ensp;&ensp;&ensp;点检周期&nbsp;&nbsp;</label>
                                            ...
                                            <div class="form-group " id="meizhoudiv" style="display: none;">
                                            ...
                                            <div class="form-group" id="meiyuediv" style="display: none;height: 28px;margin-left: 110px;margin-right: 3px;">
                                                <select id="yuehao" style="width: 100px;">
                                            ...
                                            <div class="form-group width30" id="zhidingriqi"  style="display: none;margin-left: 38px;">
                                                <label>保养日期&nbsp;&nbsp;&nbsp;</label>
                                        ...
                                        <%--    <div class="form-group width30">
                                           ...
                                           --%>
                                            <div class="form-group width30" style="padding-left: 30px;" id="tixingshijian">
                                                <label >&ensp;提醒时间&nbsp;&nbsp;</label>
                                                <input style="width: 77px" type="text"  class="form-control checkFloat" id="xtsj"
                                                       name="Description" ><span style="margin-left: -14px;">小时</span>
                                            </div>
                                ...
                                <div>
                                    ...
                                    <div class="tab-pane" id="tab_4" style="margin-top: 20px">
                                        ...
                                        <div class="boxx">
                                            ...
                                            <select class="selectpicker" multiple data-live-search="true" id="bynrqd" title="请选择点检任务清单">
...
<script src="${pageContext.request.contextPath}/static/pnsadmin/Module/process/check/checkinfo.js?v=2"></script>
</body>
</html>
