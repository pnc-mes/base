...
<body>
<div class="btn-group td1 table tabTop aa">
    <%--<div class="btn btn-primary cSelect">筛选</div>--%>
    <div class="btn-group">
        <div class="btn btn-primary dropdown-toggle" data-toggle="dropdown" aria-expanded="true" id="option0">新增
            <span class="caret"></span>
        </div>
        <ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu1">
            <li role="presentation"><a class="text-center cAdd" role="menuitem" tabindex="-1" >新增类别</a></li>
            <li role="presentation"><a class="text-center cAdd1" role="menuitem" tabindex="-1" >新增子类别</a></li>
        </ul>
    </div>
...
<div class="f2 clearfix">
    <div class="zsyLeft">
        <div class="left zsyZi" id="left2">
            <input class="input1 form-control" type="search" name="" value="" placeholder="物料类别名称">
    ...
    <div class="right" id="_right">
        <form class="form-inline" id="matypeinfo">
            <div class="row rightTop">
                <div class="col-md-12">
                    <div class="nav-tabs-custom">
                        <ul class="nav nav-tabs">
                            <li class="active"><a href="#tab_1" data-toggle="tab" class="dymb">物料类别信息</a></li>
                                ...
                                <div class="box-body formBottom">
                                    <div class="printTInfo">
                                        <div class="form-group formgroup biaodan1 hangji">
                                            <label for="mTCode">物料类别代码&nbsp;&nbsp;</label>
                                            <input type="text" class="form-control check" id="mTCode" name="mTCode"
                                                   placeholder="" maxlength="30">
                                            <label for="mTName">物料类别名称&nbsp;&nbsp;</label>
                                            <input type="text" class="form-control check" id="mTName" name="mTName"
                                                   placeholder="" maxlength="40">
                                        </div><br/>
                                        <div class="form-group formgroup biaodan1 hangji" style="margin-top: 10px;">
                                            <label for="kzdxdi">扩展字段定义&nbsp;&nbsp;</label>
                                            <div id="kzdxdi" data-id=""></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<script src="${pageContext.request.contextPath}/static/pnsadmin/Module/process/matype/matypeinfo.js?v=1"></script>
</body>
</html>
