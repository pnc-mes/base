                    ...
                    <div class="gridPanel">
                        <div class="form-group">
                            <div class="form-group formgroup">　
                                物料文件<input type="text" class="check" id="fileName" style="margin-right: 0px" name="fileName" readonly placeholder="">
                            ...
                            <div class="form-group formgroup" style="color: red;font-size: 12px;">　
                                提示:支持一个或者多个物料单的同时导入操作,具体操作:只需要在Excel文件中建立一个或者多个Sheet即可实现
                            </div>
                        </div>
                        <input type="radio" id="maRadio"/>发现相同物料则更新
                    </div>
                </div>
            </div>
        </div>
...
<script src='${pageContext.request.contextPath}/static/pnsadmin/Module/process/material/importmaterial.js?v=1'></script>
</body>
</html>
