...
<div class="f2 clearfix">
    ...
    <div class="zsyLeft">
        <div class="left left1 zsyZi" id="left2">
            <input class="input1 form-control" type="search" name="" value="" placeholder="物料家族名称">
                ...
                <div class="col-md-12">
                    <div class="nav-tabs-custom">
                        <ul class="nav nav-tabs">
                            <li class="active"><a href="#tab_1" data-toggle="tab" class="dymb">物料家族信息</a></li>
                                ...
                                <div class="box-body form-inline">
                                    <div class="printTInfo">
                                        <div class=" formgroup disblock">
                                            <label for="pdfName">家族名称</label>
                                            <input type="text" class="form-control check" id="pdfName"
                                                   name="pdfName" placeholder="" maxlength="80">
                                            <label class=""  style="margin-left: -44px;">序号规则</label>
                                            <div id="defaultSelect" data-id=""></div>
                                            <label class="" style="margin-left: 70px;">物料标签</label>
...
<script src='${pageContext.request.contextPath}/static/pnsadmin/Module/process/prodfamily/prodfamily.js?v=2'></script>
