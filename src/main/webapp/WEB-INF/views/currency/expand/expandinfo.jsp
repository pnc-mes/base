...
<div class="btn-group table tabTop td1 common">
    ...
    <div class="btn-group">
        ...
        <ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu1">
            ...
            <li role="presentation"><a name="copy" class="text-center resert" role="menuitem" tabindex="-1">重置</a></li>
        </ul>
    </div>
...
<div class="f2 clearfix">
    <div class="zsyLeft" >
        <div class="left left1 zsyZi" id="left2" >
            <input class="input1 form-control" type="search" name="" value="" placeholder="搜索扩展字段定义">
                ...
                <div class="col-md-12">
                    <div class="nav-tabs-custom">
                        <ul class="nav nav-tabs">
                            <li class="active"><a href="#tab_1" data-toggle="tab" class="dymb">自定义数据</a></li>
                                ...
                                <div class="box-body form-inline">
                                    <div class="printTInfo">
                                        <div class=" formgroup disblock">
                                            <label for="CusDataName">扩展字段定义名称&nbsp;&nbsp;</label>
                                            <input type="text" class="form-control check" id="CusDataName"
                                                   name="CusDataName" placeholder="" maxlength="50">
                                        </div>
                                        <div class=" formgroup disblock" style="margin-left: 54px">
                                            <label for="kzdx">扩展对象&nbsp;&nbsp;</label>
                                            <select id="kzdx">
                                                <option selected value="0"></option>
                                                <option value="00">物料信息</option>
                                                <option value="01">设备信息</option>
                                            </select>
                                        </div>
                                        <div class=" formgroup disblock" style="margin-left: 54px">

                                            <label><input type="checkbox" id="objcheck"/>&nbsp;&nbsp;直接应用对象</label>
                                        </div>
                                    </div>
                                </div>
...
<script src='${pageContext.request.contextPath}/static/pnsadmin/Module/currency/expand/expandinfo.js?v=1'></script>
