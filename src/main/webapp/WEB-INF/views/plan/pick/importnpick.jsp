                    ...
                    <div class="gridPanel">
                        <div class="form-group">
                            <div class="form-group formgroup">　
                                领料单文件<input type="text" class="check" id="fileName" style="margin-right: 0px" name="fileName" readonly placeholder="">
                                            <span class="btn btn-success start fileinput-button" style="position: relative;">
                                                <i class="fa fa-upload"></i>
                                                <span> 上传 </span>
                                            <input type="file" id="file" readonly name="file"  multiple="" enctype="multipart/form-data">
                                            </span>
                                <span id="pCode" style="color: red;margin-left: 10px;"></span>
                            </div>
                            <div class="form-group formgroup" style="color: red;font-size: 12px;">　
                                提示:支持一个或者多个领料单的同时导入操作,具体操作:只需要在Excel文件中建立一个或者多个Sheet即可实现
                            </div>
                        </div>
                    </div>
                </div>
...
<script src='${pageContext.request.contextPath}/static/pnsadmin/Module/plan/pick/importnpick.js?v=1'></script>
</body>
</html>
