...
<head>
    ...
    <link rel="stylesheet" type="text/css"
          href="${pageContext.request.contextPath}/static/plugins/selectpage/selectpage.bootstrap3.css">
</head>
<div class="btn-group table tabTop common td1">
    ...
    <div class="btn-group">
        ...
        <ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu1">
            <li role="presentation"><a href="#" class="text-center" role="menuitem" id="remove" tabindex="-1">删除</a>
            </li>
            <%--<li role="presentation"><a href="#" class="text-center" role="menuitem" id="xd" tabindex="-1">下达</a>
            </li>
            <li role="presentation"><a href="#" class="text-center" role="menuitem" id="cancel" tabindex="-1">取消</a>
            </li>
            <li role="presentation"><a href="#" class="text-center" role="menuitem" id="freeze" tabindex="-1">冻结</a>
            </li>
            <li role="presentation"><a href="#" class="text-center" role="menuitem" id="thaw" tabindex="-1">解冻</a>
            </li>
            <li role="presentation"><a href="#" class="text-center" role="menuitem" id="stop" tabindex="-1">终止</a>
            </li>
            <li role="presentation"><a href="#" class="text-center" role="menuitem" id="start" tabindex="-1">开始</a>
            </li>--%>
            <%--<li role="presentation"><a href="#" class="text-center" role="menuitem" id="close" tabindex="-1">关闭</a>--%>
            </li>
        </ul>
    </div>
    <%--<div class="btn-group">
...
<div class="f2 clearfix zsyLeft1">
    <div class="left zsyZi1 left1" id="left2">
        <input class="input1 form-control" type="search" name="" value="" placeholder="搜索订单号">
                ...
                <div class="col-md-12">
                    <div class="nav-tabs-custom">
                        <ul class="nav nav-tabs">
                            <li class="active"><a href="#tab_1" data-toggle="tab" class="dymb">订单基本信息</a></li>
                                ...
                                <div class="box-body  form-inline">
                                    <div class="printTInfo">
                                        <div class="manWidth">
                                            <div class="form-group width30">
                                                ...
                                                <input type="text" class="form-control" id="OrderCode"
                                                       name="ptName" placeholder="订单号可自动生成" maxlength="50" readonly>
                                            </div>
                                            <div class="form-group width30">
                                                <label for="OrderCode">订单类型</label>
                                                <div id="OrderType" data-id=""></div>
                                            </div>
                                            <div class="form-group width30">
                                                <label>产品名称</label>
                                        ...
                                        <div class="cpxx2 cpmcx manWidth">
                                            <div class="form-group width30">
                                                <label class="mright3 num">&emsp;数量</label>
                                                <input type="number" class="form-control check" id="Num" maxlength="10"><label
                                                    id="unit" value=""></label>
                        ...
                        <div class="nav-tabs-custom mtop">
                            <ul class="nav nav-tabs">
                                <li class="active"><a href="#tab_3" data-toggle="tab" class="dymb">关联工单</a></li>
                            </ul>
                            <div class="tab-content">
...
<script src='${pageContext.request.contextPath}/static/pnsadmin/Module/plan/cuorder/order.js?v=1'></script>
