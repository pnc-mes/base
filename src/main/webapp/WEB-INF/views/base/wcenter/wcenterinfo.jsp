...
<div class="f2 clearfix">
    <div class='zsyLeft'>
        <div class="left left1 zsyZi" id="left2">
            <input class="input1 form-control" type="search" name="" value="" placeholder="搜索工作中心">
                ...
                <div class="col-md-12">
                    <div class="nav-tabs-custom">
                        <ul class="nav nav-tabs">
                            <li class="active"><a href="#tab_1" data-toggle="tab" class="dymb">工作中心</a></li>
                                ...
                                <div class="box-body form-inline">
                                    <div class="printTInfo">
                                        <div class=" formgroup disblock">
                                            <label for="wCName">工作中心名称</label>
                                            <input type="text" class="form-control check" id="wCName"
                                                   name="wCName" placeholder="" maxlength="40">
                                            <label class="">所属工厂</label>
...
<script src='${pageContext.request.contextPath}/static/pnsadmin/Module/base/wcenter/wcenterinfo.js?v=1'></script>
