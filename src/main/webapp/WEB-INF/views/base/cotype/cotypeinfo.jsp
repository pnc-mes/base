...
<div class="f2 clearfix">
    <div class="zsyLeft" >
        <div class="left left1 zsyZi" id="left2" >
            <input class="input1 form-control" type="search" name="" value="" placeholder="搜索订单类型">
                ...
                <div class="col-md-12">
                    <div class="nav-tabs-custom">
                        <ul class="nav nav-tabs">
                            <li class="active"><a href="#tab_1" data-toggle="tab" class="dymb">订单类型信息</a></li>
                                ...
                                <div class="box-body form-inline">
                                    <div class="printTInfo">
                                        <div class=" formgroup disblock">
                                            <label for="CTName">订单类型名称</label>
                                            <input type="text" class="form-control check" id="CTName"
                                                   name="CTName" placeholder="" maxlength="50">
...
<script src='${pageContext.request.contextPath}/static/pnsadmin/Module/base/cotype/cotypeinfo.js?v=1'></script>
