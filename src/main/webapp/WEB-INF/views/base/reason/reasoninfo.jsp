...
<div class="f2 clearfix">
    <div class="zsyLeft">
        <div class="left zsyZi left1" id="left2">
                ...
                <div class="col-md-12">
                    <div class="nav-tabs-custom">
                        <ul class="nav nav-tabs">
                            <li class="active"><a href="#tab_1" data-toggle="tab" class="dymb">原因代码信息</a></li>
...
<script src='${pageContext.request.contextPath}/static/pnsadmin/Module/base/reason/reasoninfo.js?v=1'></script>
