...
<div class="f2 clearfix">
    <div class="zsyLeft" >
        <div class="left left1 zsyZi" id="left2" >
            <input class="input1 form-control" type="search" name="" value="" placeholder="搜索工厂名称">
                ...
                <div class="col-md-12">
                    <div class="nav-tabs-custom">
                        <ul class="nav nav-tabs">
                            <li class="active"><a href="#tab_1" data-toggle="tab" class="dymb">工厂信息</a></li>
                                ...
                                <div class="box-body form-inline">
                                    <div class="printTInfo">
                                        <div class=" formgroup disblock">
                                            <label for="faName">工厂名称</label>
                                            <input type="text" class="form-control check" id="faName"
                                                   name="faName" placeholder="" maxlength="50">
...
<script src='${pageContext.request.contextPath}/static/pnsadmin/Module/base/factory/factoryinfo.js?v=1'></script>
