...
<div class="f2 clearfix">
    <div class="zsyLeft" >
        <div class="left left1 zsyZi" id="left2" >
            <input class="input1 form-control" type="search" name="" value="" placeholder="搜索线别名称">
                                ...
                                <div class="box-body form-inline">
                                    <div class="printTInfo">
                                        <div class=" formgroup disblock">
                                            <label for="lineCode">线体代码</label>
                                            <input type="text" class="form-control check" id="lineCode"
                                                   name="lineCode" placeholder="" maxlength="40">
                                        </div>

                                        <div class=" formgroup disblock">
                                            <label for="liName">线体名称</label>
                                            <input type="text" class="form-control check" id="liName"
                                                   name="liName" placeholder="" maxlength="40">
                                        </div>

                                        <div class=" formgroup disblock">
                                            <label>工&emsp;&emsp;厂</label>
                                            <div id="defaultSelect" data-id=""></div>

                                        </div>
                                        <div class=" formgroup disblock">
                                            <label for="lineDes">描&emsp;&emsp;述</label>
                                            <input type="text" class="form-control" id="lineDes"
                                                   name="lineDes" placeholder="" style="width:530px;" maxlength="255">
                                        </div>

                                        <div class=" formgroup disblock">
                                            <label class="" for="scxb">代工线体设置</label>
                                            <select  class="selectpicker" multiple data-live-search="true" id="scxb" title="请选择线体">
                                            </select>
                                        </div>

                                        <%--<div class=" formgroup disblock">
                                            <label for="Linecapacity">线产能&emsp;</label>
                                            <input type="text"  onkeyup="value=value.replace(/[^\d]/g,'')" class="form-control check" id="Linecapacity"
                                                   name="Linecapacity" placeholder="" maxlength="60">
                                        </div>

                                        <div class=" formgroup disblock">
                                            <div style="margin-top: 25px;" id="bb">
                                                <input type="checkbox"  id="IsOEM" name="IsOEM">&emsp;允许其他线体代工（OEM)
                                            </div>
                                        </div>
                                        <div class="form-group width30" id="aa" style="">
                                            <label class="">生&nbsp;产&nbsp;线&nbsp;别</label>
                                            <select  placeholder="工单号可自动生成" class="selectpicker" multiple data-live-search="true" id="scxb">
                                            </select>
                                        </div>--%>
                                    </div>
...
<script src='${pageContext.request.contextPath}/static/pnsadmin/Module/base/line/line.js?v=1'></script>
