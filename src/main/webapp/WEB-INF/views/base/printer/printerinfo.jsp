...
<div class="f2 clearfix">
    <div class="zsyLeft">
        <div class="left zsyZi" id="left2">
            <input class="input1 form-control" type="search" name="" value="" placeholder="搜索打印机名称">
    ...
    <div class="right" id="_right">
        <form class="form-inline" id="printerinfo">
            <div class="row rightTop">
                <div class="col-md-12">
                    <div class="nav-tabs-custom">
                        <ul class="nav nav-tabs">
                            <li class="active"><a href="#tab_1" data-toggle="tab" class="dymb">打印机信息</a></li>
                                ...
                                <div class="box-body formBottom">
                                    <div class="printTInfo">
                                        <div class="form-group formgroup biaodan1 hangji">
                                            <label for="prName">打印机名称</label>
                                            <input type="text" class="form-control check" id="prName" name="prName"
                                                   placeholder="" maxlength="80">
                                            <label for="prSer">打印工作站</label>
                                            <input type="text" class="form-control check" id="prSer" name="prSer"
...
<script src='${pageContext.request.contextPath}/static/pnsadmin/Module/base/printer/printerinfo.js?v=1'></script>
</body>
</html>
