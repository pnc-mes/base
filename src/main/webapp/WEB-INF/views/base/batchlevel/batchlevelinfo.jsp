...
<div class="f2 clearfix">
    <div class="zsyLeft">
        <div class="left zsyZi" id="left2">
            <input class="input1 form-control" type="search" name="" value="" placeholder="批次等级名称">
    ...
    <div class="right" id="_right">
        <form class="form-inline" id="batchlevelinfo">
            <div class="row rightTop">
                <div class="col-md-12">
                    <div class="nav-tabs-custom">
                        <ul class="nav nav-tabs">
                            <li class="active"><a href="#tab_1" data-toggle="tab" class="dymb">批次等级信息</a></li>
                                ...
                                <div class="box-body formBottom">
                                    <div class="printTInfo">
                                        <div class="form-group formgroup biaodan1 hangji">
                                            <label for="bLName">等级名称</label>
                                            <input type="text" class="form-control check" id="bLName" name="bLName"
...
<script src="${pageContext.request.contextPath}/static/pnsadmin/Module/base/batchlevelinfo/batchlevelinfo.js?v=1"></script>
</body>
</html>
