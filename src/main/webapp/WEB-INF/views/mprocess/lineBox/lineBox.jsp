            ...
            <div class="col-md-12">
                <div class="box-body form-inline clearfix">
                    <div class="printTInfo mb contentLeft">
                        <div class=" formgroup ">
                            <label for="batch">组件条码&emsp;&emsp;&emsp;</label>
                            <input type="text" class="form-control check" id="batch" name="ptName" maxlength="30"/>
                        </div>
                        <div class=" formgroup biaoqian">
                            <label for="batch">前EL测试结果&ensp;</label>
                            <input type="text" class="form-control check" id="el" name="ptName" maxlength="30"/>
                        </div>
                        <div class=" formgroup biaoqian">
                            <label for="batch">接线盒编号&emsp;&emsp;</label>
                            <input type="text" class="form-control check" id="boxid" name="ptName" maxlength="30"/>
                        </div>
                        <div class=" formgroup biaoqian">
                            <label for="MaCode">工&ensp;单&ensp;号&emsp;&emsp;&emsp;</label>
                            <input type="text" class="form-control" id="MaCode" readonly name="MaName" placeholder="">
                        </div>
                        <div class=" formgroup biaoqian">
                            <label for="MaName">生产线别&emsp;&emsp;&emsp;</label>
                            <input type="hidden" id="MaVerRd" name="MaVerRd"/>
                            <input type="text" class="form-control" id="MaName" readonly name="MaName"
                                   placeholder="">
                        </div>
                        <div class=" formgroup biaoqian">
                            <label for="WoCode">班&emsp;&emsp;别&emsp;&emsp;&emsp;</label>
                            <input type="text" class="form-control" id="WoCode" readonly name="MaName" placeholder="">
                        </div>
                        <div class="formgroup biaoqian">
                            <label for="Num">操&ensp;作&ensp;员&emsp;&emsp;&emsp;</label>
