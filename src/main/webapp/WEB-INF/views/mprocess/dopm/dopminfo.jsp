                ...
                <div class="col-md-12">
                    <div class="nav-tabs-custom">
                        <div class=" formgroup disblock" style="margin-top: 38px;margin-left: 12px;">
                            <label>保养类型&nbsp;&nbsp;</label>
                            <select id="bylx" style="width: 115px">
                                <option value="00">周期性保养</option>
                                <option value="01">次数保养</option>
                            </select>

                            <label style="margin-left: 50px;">保养对象类型&nbsp;&nbsp;</label>
                            <select id="bydxlx"  style="width: 115px">
                                <option value="00">设备</option>
                                <option value="01">工具</option>
                                <option value="02">载具</option>
                            </select>
                            <span style="margin-left: 30px;">保养对象&nbsp;&nbsp;</span>
                            <label  >
                                <div data-id="" style="display: none;" id="shebei">
                                    <select class="selectpicker" style="display: none;"  id="shebeis" multiple data-live-search="true"  data-max-options="1" title="请选择设备">
                                    </select>
                                </div>
                                <div style="display: none;" id="gongju">
                                    <select class="selectpicker" style="display: none;" id="gongjus" multiple data-live-search="true"  data-max-options="1" title="请选择工具">
                                    </select>
                                </div>
                                <div style="display: none;" id="zaiju">
                                    <select class="selectpicker" style="display: none;" id="zaijus" multiple data-live-search="true"  data-max-options="1" title="请选择载具">
                                    </select>
                                </div>
                            </label>

                            <%--<div id="shebei" data-id="" style="display: none;"></div>
                            <div id="gongju" data-id="" style="display: none;"></div>
                            <div id="zaiju" data-id="" style="display: none;"></div>--%>
                        ...
                        <div class=" formgroup"  style="margin-left: 12px;">
                            <label>任务清单&nbsp;&nbsp;</label>
                            <select id="rwqd"  style="width: 115px">

                            </select>
                        </div>
                        <div class="nav-tabs-custom " style="margin-top: 10px;margin-left: 67px;">

                            <table border="1" style="width: 90%;border:1px solid  #CFCFCF; margin-left: 12px;">
                                <thead>
                                    <tr><td style="color: #333333; font-size: 14px;text-align:center;vertical-align:middle;width: 45%;" id="rwms">任务描述</td><td style="color: #333333;font-size: 14px; text-align:center;vertical-align:middle;width: 45%">确认方式</td></tr>
                                </thead>
                                <tbody id="tbody">
...
<script src='${pageContext.request.contextPath}/static/pnsadmin/Module/mprocess/dopm/dopminfo.js?v=1'></script>
