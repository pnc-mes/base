                            ...
                            <div class="tab-pane active clearfix" id="tab_1" style="margin-top: 30px;">
                                <div class=" form-inline">
                                    <div class="nav-tabs-custom">
                                        ...
                                        <div class="bBottom" >
                                            &emsp;&emsp;&emsp;&emsp;&emsp;<label for="ID">ID&ensp;</label>
                                            <input  id="ID" />
                                        </div>
...
<script src='${pageContext.request.contextPath}/static/pnsadmin/Module/mprocess/carrierload/carrierloadInfo.js?v=1'></script>
