                                ...
                                <div class=" form-inline">
                                    <div class="nav-tabs-custom">
                                        ...
                                        <div class="bBottom">
                                            ...
                                            <label for="CZPCode">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;物料总数&ensp;</label>
                                            <input type="number" class="form-control" id="ZSnumber" name="ZSnumber" autocomplete="off"  disabled style="width: 100px;" />
                                            <label for="CZPCode">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;可用数量&ensp;</label>
                                            <input type="number" class="form-control" id="KYnumber" name="KYnumber" autocomplete="off"  disabled style="width: 100px;" />
                                            <label for="CZPCode">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;下料数量&ensp;</label>
                                            <input type="number" class="form-control" id="number" name="number" autocomplete="off" style="width: 100px" />
                                            <label for="Remark">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;备注&ensp;</label>
                                            <input type="text" class="form-control" id="Remark" name="Remark" autocomplete="off" style="width: 100px" />
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<script src='${pageContext.request.contextPath}/static/pnsadmin/Module/mprocess/xl/xlFoolProofInfo.js?v=1'></script>
