                ...
                <div class='f1'>
                    <div class="form-group formgroup">
                       <label>箱号</label>
                        ...
                        <label>原是否返工</label>
                       <%-- <input type="checkbox" class="form-control " readonly disabled id="remark" name="" maxlength="50">--%>

                        <input type="checkbox" id="remark"  disabled/>
                        <label>修改是否返工</label>
                      <%--  <input type="checkbox" class="form-control " style="width: 250px;" id="newremark" name="">--%>
                        <input type="checkbox" id="newremark" />
                    </div>
...
<script src="${pageContext.request.contextPath}/static/pnsadmin/Module/mprocess/pack/repageinfo.js"></script>
</body>
</html>
