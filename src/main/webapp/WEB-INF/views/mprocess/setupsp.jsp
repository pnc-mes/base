                                    ...
                                    <div class="box-body  form-inline">
                                        <div class='f1'>
                                            <div class="form-group formgroup">
                                                <label>工单号</label>
                                                <input type="text" class="form-control check" id="batchNum"
                                                       name="batchNum">
                                                <label for="workFlow">工艺流程</label>
                                                <input type="text" class="form-control" id="workFlow" name="workFlow"
                                                       placeholder="" list="workFlow_list">
                                                <datalist id="workFlow_list">
                                                </datalist>
                                                <label for="workProcedure">工序</label>
                                                <input type="text" class="form-control" id="workProcedure" name="workProcedure"
                                                       placeholder="" list="workProcedure_list">
                                        ...
                                        <div class="boxx">
                                            <div class="nav-tabs-custom">
                                                <ul class="nav nav-tabs">
                                                    <li class="active"><a href="#tab_1" data-toggle="tab" class="dymb">工序物料存量</a></li>
                                                </ul>
