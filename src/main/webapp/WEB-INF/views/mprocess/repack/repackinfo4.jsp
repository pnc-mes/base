            ...
            <div class="box-body  form-inline">
                <div class='f1'>
                    <div class="form-group formgroup">
                        ...
                        <label>冻结原因</label><input style="width: 200px" id="remark"/>
                    ...
                    <div class="f2_4 btn-group col-sm-12">
                        <div class="nav-tabs-custom">
                            <ul class="nav nav-tabs ul">
                                <li class="active"><a href="#tab_1" data-toggle="tab">箱子组件信息</a></li>
                            </ul>
...
<script src="${pageContext.request.contextPath}/static/pnsadmin/Module/mprocess/repack/repackinfo4.js"></script>
</body>
</html>
