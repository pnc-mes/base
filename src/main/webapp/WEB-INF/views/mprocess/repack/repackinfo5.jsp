            ...
            <div class="box-body  form-inline">
                <div class='f1'>
                    <div class="form-group formgroup">
                        &nbsp;&nbsp; <input type="text" class="form-control " placeholder="搜索箱号" id="selectBarCode" name="" maxlength="50">
                       <%-- <input type="text" class="form-control " placeholder="箱号" id="Code" name="" maxlength="50">--%>
                        <input type="hidden" id="BarType"/>

                        <label>解冻原因</label><input style="width: 200px" id="remark"/>
                    ...
                    <div class="f2_4 btn-group col-sm-12">
                        <div class="nav-tabs-custom">
                            <ul class="nav nav-tabs ul">
                                <li class="active"><a href="#tab_1" data-toggle="tab">箱子冻结信息</a></li>
                            </ul>
...
<script src="${pageContext.request.contextPath}/static/pnsadmin/Module/mprocess/repack/repackinfo5.js"></script>
</body>
</html>
