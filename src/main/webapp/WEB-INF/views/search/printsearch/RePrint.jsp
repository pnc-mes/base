                        ...
                        <div class="form-group">
                            ...
                            <div class="block bBottom1">
                                <div class="form-group">
                                    ...
                                    <select class="form-control selectpicker" id="prints" title="请选择打印机" data-live-search="true" data-max-options="1" multiple>
                            ...
                            <div class="block bBottom">
                                <div class="form-group">
                                    <input type="checkbox" id="isPrintT" />选择其他模板
                                </div>
                            </div>
                            ...
                            <div class="block bBottom1">
                                <div class="form-group">
                                    ...
                                    <select class="form-control selectpicker" id="PrintTs" title="请选择打印模板" data-live-search="true" data-max-options="1" multiple>
                            ...
                            <div class="block bBottom">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="printCount"
                                           name="fileGpName" readonly value="1" style="display: inline-block;width: 300px;">
                                </div>
                            </div>
                            <div class="block">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="printCopy"
                                           name="fileGpName" value="1" style="display: inline-block;width: 300px;">
                                </div>
                            </div>
                        </div>
                    </div>
...
<script src='${pageContext.request.contextPath}/static/pnsadmin/Module/search/printsearch/RePrint.js?v=1'></script>
