...
<div class="contation">
    ...
    <div class="box-body form-inline" style="margin-bottom: 10px;margin-left: 10px;">
        <div class="form-group formgroup">
            <label for="tjtm">条码</label>
            <input type="text" class="form-control" style="width: 200px;" id="tjtm" maxlength="50">
        </div>
        <div class="form-group formgroup scxb" style="margin-left: 10px;">
        ...
        <div class="form-group formgroup" style="margin-left: 10px;">
            <input type="button" class="layui-input" id="cx" value="查询" >
        </div>
    </div>
...
<script src='${pageContext.request.contextPath}/static/pnsadmin/Module/search/printsearch/printsearch.js?v=1'></script>
</body>
</html>
